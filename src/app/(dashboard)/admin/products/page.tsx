  ...
  return (
    <div className="w-full">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 flex flex-col items-center justify-center min-h-[400px] text-center">
        ...
        <h2 className="text-xl font-semibold text-gray-800 mb-2">Product Management</h2>
        <p className="text-gray-500 max-w-md">This page is under construction. Soon you will be able to add and edit products here.</p>
      </div>
    </div>
  );
}
