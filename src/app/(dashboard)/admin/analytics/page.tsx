  ...
  return (
    <div className="w-full">
      <div className="flex items-center gap-3 mb-6">
        <LineChart className="w-8 h-8 text-gray-800" />
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 flex flex-col items-center justify-center min-h-[400px] text-center">
        ...
        <h2 className="text-xl font-semibold text-gray-800 mb-2">Sales Analytics</h2>
        <p className="text-gray-500 max-w-md">This page is under construction. Soon you will see detailed charts and reports here.</p>
      </div>
    </div>
  );
}
